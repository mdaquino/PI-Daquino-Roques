                    ...
                    <>
                        ...
                        <section className="row">
                            <section className="col-md-6 info">
                                ...
                                <p className="mt-0 mb-0" id="release-date"><strong>Fecha de estreno:</strong>{this.state.personaje.first_air_date}</p>
                                <p className="mt-0 mb-0" id="episodes"><strong>Número de capítulos:</strong>{this.state.personaje.number_of_episodes}</p>
                                <p className="mt-0 seasons"><strong>Temporadas:</strong>{this.state.personaje.number_of_seasons}</p>
